...
export default function WalletSettingsPage() {
  ...
  return (
    <div className="space-y-3">
      <h1 className="text-xl font-semibold text-white">Wallet Settings</h1>
      <p className="text-sm text-zinc-400">Manage connected wallet security status and linkage.</p>
