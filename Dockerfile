...
ARG NEXT_PUBLIC_PAYMENT_REDIRECT_HOST_SUFFIXES=.nowpayments.io,.nowpayments.com
ENV NEXT_PUBLIC_PAYMENT_REDIRECT_HOST_SUFFIXES=${NEXT_PUBLIC_PAYMENT_REDIRECT_HOST_SUFFIXES}
